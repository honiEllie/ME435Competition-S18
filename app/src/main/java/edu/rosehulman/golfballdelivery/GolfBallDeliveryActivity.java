...
public class GolfBallDeliveryActivity extends RobotActivity {
	...
	public enum State {
        ...
        DRIVE_TOWARDS_FAR_BALL, FAR_BALL_SCRIPT,
        DRIVE_TOWARDS_HOME, WAITING_FOR_PICKUP,
        SEEKING_HOME,
    }
    ...
    */
    ...
    public void setState(State newState){
        ...
        if(mState == State.READY_FOR_MISSION && newState != State.NEAR_BALL_SCRIPT){
            Toast.makeText(this, "Illegal state transition out of READ_FOR_MISSION",
        ...
        switch (newState){
            ...
            case NEAR_BALL_SCRIPT:
                ...
                //TODO: Run a near ball script that results in removing the ball
                break;
...
//        speak("TO DO Perform a ball Test");
        // This what we would really do...
//        sendCommand("CUSTOM balltest");

        // But for testing, we are cheating
    ...
    public void handleFakeGpsH1(View view) {
        onLocationChanged(11, 0, 179.9, null);  // Out of range so ignored.
    }
    ...
    public void handleGoOrMissionComplete(View view) {
        if(mState == State.READY_FOR_MISSION){
            mMatchStartTime = System.currentTimeMillis(); // moment in time, when match starts
            updateMissionStratefyVariables();
    ...
    private void updateMissionStratefyVariables() {
        // Goal is to set these variables
        mNearBallGpsY = -50;
        mFarBallGpsY = 50;
        mNearBallLocation = 1;
